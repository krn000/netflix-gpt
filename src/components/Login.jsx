    ...
    <>
      ...
      <div className='absolute top-0 left-0 w-full h-full bg-black/50 flex justify-center items-center bg-opacity-80'>
        <form className='bg-black/50 p-10 rounded-lg w-4/12'> 
          ...
          <input type="email" placeholder='Email or phone number' className='p-2 my-4 w-full bg-gray-700 rounded-md text-white' />
          {!isSignIn && <input type="name" placeholder='Name' className='p-2 my-4 w-full bg-gray-700 rounded-md text-white' />}

          <input type="password" placeholder='Password' className='p-2 my-4 w-full bg-gray-700 rounded-md text-white' />
          <button className='p-2 my-4 w-full bg-red-700 text-white rounded-md'>{isSignIn ? 'Sign In' : 'Sign Up'}</button>
